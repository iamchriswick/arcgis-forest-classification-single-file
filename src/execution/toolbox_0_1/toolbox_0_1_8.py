# -*- coding: utf-8 -*-
"""
Forest Classification Tool - Phase 1: Basic Toolbox Structure v0.1.8
...
def log_system_capabilities_fast():
    """Log detected system capabilities with optimized performance."""
    # Start logging immediately - don't wait for system detection
    arcpy.AddMessage("🖥️ System: Detecting capabilities...")
    ...
    try:
        ...
        # Try psutil but with fast timeout/fallback
        try:
...
def main():
    """Main execution function for .atbx Script tool - optimized for speed."""

    # Immediate logging - no delays
    arcpy.AddMessage("🚀 Starting Forest Classification Tool v0.1.8")
    arcpy.AddMessage(
        "📋 Phase 1 v0.1.8: Optimized startup performance - faster logging and reduced import overhead"
    )
    ...
    # System capabilities detection (optimized)
...
class ForestClassificationToolbox(object):
    ...
    def __init__(self):
        ...
        self.label = "Forest Classification Toolbox - Phase 1 v0.1.8"
        self.alias = "ForestClassificationPhase1v0_1_8"
        self.description = "Forest species classification tool for ArcGIS Pro .atbx Script tools. Optimized for fast startup performance."
...
class ForestClassificationTool(object):
    ...
    def __init__(self):
        ...
        self.label = "Forest Classification Tool - Phase 1 v0.1.8"
        self.description = "Classifies forest features using species-specific algorithms. Optimized for fast startup and immediate logging feedback."
