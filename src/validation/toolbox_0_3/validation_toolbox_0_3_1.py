# -*- coding: utf-8 -*-
"""
ToolValidator for Forest Classification Tool - Phase 3 v0.3.1

Created: 2025-09-02
Version: 0.3.1
Built on: Phase 2 v0.2.5 foundation with enhanced field validation
...
Phase 3 = Phase 2 + comprehensive field validation:
- Inherits ALL Phase 2 GUI functionality unchanged
...
- Enhanced field validation across all data categories
