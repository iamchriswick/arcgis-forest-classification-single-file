# -*- coding: utf-8 -*-
"""
Test Suite for ToolValidator - Forest Classification Tool Phase 2 v0.2.5

Tests the ToolValidator class and helper functions for Phase 2.5 requirements.
Uses real ArcPy integration and minimal mocking per Testing Strategy.
Focuses on multi-source field mapping and IMPORT_FIELDS.json integration.
...
try:
    from validation.toolbox_0_2.validation_toolbox_0_2_5 import (
        ToolValidator,
        get_cpu_cores,
