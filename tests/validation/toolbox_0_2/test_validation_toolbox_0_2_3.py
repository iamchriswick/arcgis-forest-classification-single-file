# -*- coding: utf-8 -*-
"""
Test Suite for ToolValidator - Forest Classification Tool Phase 2 v0.2.3

Tests the ToolValidator class and helper functions for Phase 2.3 requirements.
Uses real ArcPy integration and minimal mocking per Testing Strategy.
Focuses on 3-parameter structure and parameter alignment fixes.
...
try:
    from validation.toolbox_0_2.validation_toolbox_0_2_3 import (
        ToolValidator,
        get_cpu_cores,
