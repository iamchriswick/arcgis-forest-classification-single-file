"""
Test module for Phase 1 Forest Classification Tool

Tests the basic toolbox structure, parameter definition, and simple execution.
"""
...
try:
    from toolbox_0_1_1 import ForestClassificationToolbox, ForestClassificationTool
except ImportError:
